#include "NCMCPrefsController.h"

@implementation NCMCPrefsController
- (instancetype)init {
    self = [super init];

    if (self) {
        HBAppearanceSettings *appearanceSettings = [[HBAppearanceSettings alloc] init];
        appearanceSettings.tintColor = [UIColor colorWithRed:132.0f/255.0f green:108/255.0f blue:252/255.0f alpha:1.0f];
        ...
        appearanceSettings.navigationBarBackgroundColor = [UIColor colorWithRed:132.0f/255.0f green:108/255.0f blue:252/255.0f alpha:1.0f];
...
- (NSArray *)specifiers {
	if (!_specifiers) {
		_specifiers = [[self loadSpecifiersFromPlistName:@"MusicController" target:self] retain];
	}
...
- (void)viewDidLoad {
    ...
    self.headerCoverView.backgroundColor = [UIColor colorWithRed:132.0f/255.0f green:108/255.0f blue:252/255.0f alpha:1.0f];
    ...
    self.bannerTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 75, 350, 40)];
    NSMutableAttributedString *text = [[NSMutableAttributedString alloc] initWithString:@"Music Controller Module"];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.navigationController.navigationController.navigationBar.barTintColor = [UIColor colorWithRed:132.0f/255.0f green:108/255.0f blue:252/255.0f alpha:1.0f];
